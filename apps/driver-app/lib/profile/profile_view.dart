...
class _ProfileViewState extends State<ProfileView> {
          ...
          children: [
            ...
            Query(
                options: QueryOptions(
                    document: GET_DRIVER_QUERY_DOCUMENT, fetchPolicy: FetchPolicy.noCache),
                  ...
                  return Mutation(
                    options: MutationOptions(
                        ...
                        update: (GraphQLDataProxy cache, QueryResult? result) {
                          final driver = SetDocumentsOnDriver$Mutation.fromJson(result!.data!);
                          cache.writeQuery(Operation(document: ME_QUERY_DOCUMENT).asRequest(),
                              data: {
                    ...
                    builder: (RunMutation runSetDocumentsMutation,
                        ...
                        Mutation(
                            options: MutationOptions(
                                ...
                                fetchPolicy: FetchPolicy.noCache),
                            builder: (RunMutation runLoginMutation, QueryResult? loginResult) {
                              return Mutation(
                                  options: MutationOptions(
                                  ...
                                  builder: (
                                    ...
                                    return Stepper(
                                          ...
                                          switch (_currentStep) {
                                              ...
                                              if (kIsWeb) {
                                                ...
                                                FirebaseAuth.instance.verifyPhoneNumber(
                                                    ...
                                                    verificationCompleted:
                                                      ...
                                                      login(phoneAuthCredential, runLoginMutation);
                                                    },
                                                    verificationFailed:
                                            ...
                                            case 5:
                                              final inp = SetDocumentsOnDriverArguments(
                                                  driverId: driver.id,
                                                  relationIds:
                                                      driver.documents.map((e) => e.id).toList());
                                        ...
                                        steps: <Step>[
                                          ...
                                          Step(
                                              title: Text(
                                                S.of(context).driver_register_contact_details_title,
                                                style: TextStyle(
                                                  color: colorScheme.onSecondaryContainer,
                                                ),
                                              ),
                                                ...
                                                child: Column(children: [
                                                  ...
                                                  TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                        isDense: true,
                                                        labelText:
                                                            S.of(context).certificate_number),
                                                  ),
                                                  const SizedBox(height: 8),
                                              ...
                                              content: Form(
                                                  ...
                                                  child: Column(children: [
                                                      ...
                                                      children: [
                                                        ...
                                                        Flexible(
                                                          child: TextFormField(
                                                            ...
                                                            initialValue: driver.carProductionYear
                                                                    ?.toString() ??
                                                                "",
                                                            style: TextStyle(
                                                              color:
                                                    ...
                                                    DropdownButtonFormField<String>(
                                                      ...
                                                      decoration: InputDecoration(
                                                          isDense: true,
                                                          labelText: S.of(context).car_model),
                                                      items: models
                                                    ...
                                                    children: [
                                                      ...
                                                      TextFormField(
                                                        ...
                                                        decoration: InputDecoration(
                                                            isDense: true,
                                                            labelText:
                                                                S.of(context).bankRoutingNumber),
                                                        validator: (value) {
                                                          if (value.isEmptyOrNull) {
                                                            return S
                                                                .of(context)
                                                        ...
                                                        onChanged: (value) =>
                                                            driver.bankRoutingNumber = value,
                                                      ),
                                                    ],
                                                  ))),
                                          Step(
                                              ...
                                              content: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    S.of(context).driver_register_document_first,
                                                    style: TextStyle(
                                                      color: colorScheme.onSecondaryContainer,
                                                    ),
                                                  ).pOnly(bottom: 8),
                                                  Text(
                                                    S.of(context).driver_register_document_second,
                                                    style: TextStyle(
                                                      color: colorScheme.onSecondaryContainer,
                                                    ),
                                                  ).pOnly(bottom: 8),
                                                  Text(
                                                    S.of(context).driver_register_document_third,
                                                    style: TextStyle(
                                                      color: colorScheme.onSecondaryContainer,
                                                    ),
                                                  ).pOnly(bottom: 8),
                                                  GridView.count(
                                                    ...
                                                    children: driver.documents
                                                        .map(
                                                          (e) =>
                                                              Image.network(serverUrl + e.address)
                                                                  .w20(context),
                                                        )
                                                        .toList(),
  ...
  uploadFile(String path) async {
    ...
    request.headers['Authorization'] = 'Bearer ${Hive.box('user').get('jwt').toString()}';
