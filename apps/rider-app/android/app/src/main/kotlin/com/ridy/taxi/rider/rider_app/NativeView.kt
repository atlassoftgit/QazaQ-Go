...
import money.paybox.payboxsdk.BuildConfig
...
internal class NativeView(context: Context, id: Int, creationParams: Map<String?, Any?>?, binaryMessenger : BinaryMessenger) : PlatformView {
    ...
    init {
      ...
      if (call.method == "setUrl") {
        ...
        sdk.createPayment(amount.toFloat(), "Pay for your trip", "12345", phoneNumber, null) {
                    payment, error -> Log.e("initPAY", payment?.status ?: "unknown")
