...
class CreateOrderInput extends JsonSerializable with EquatableMixin {
  ...
  @override
  List<Object?> get props =>
      [serviceId, intervalMinutes, points, addresses, twoWay, optionIds];
  @override
...
class PayRideArguments extends JsonSerializable with EquatableMixin {
  PayRideArguments(
      {required this.input, required this.orderId, this.tipAmount});
  ...
  @override
  List<Object?> get props => [input, orderId, tipAmount];
  @override
