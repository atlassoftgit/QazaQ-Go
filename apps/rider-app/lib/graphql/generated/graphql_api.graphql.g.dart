...
GetOrderDetails$Query$Order _$GetOrderDetails$Query$OrderFromJson(
    Map<String, dynamic> json) {
  print(json);
  final points = <GetOrderDetails$Query$Order$Point>[];

  ((json['points'] as List<dynamic>?) ?? []).map((e) {
    if (e != null) {
      points.add(GetOrderDetails$Query$Order$Point.fromJson(
          e as Map<String, dynamic>));
    }
  });

  return GetOrderDetails$Query$Order()
    ..points = points
    ..addresses =
...
GetDriversLocation$Query _$GetDriversLocation$QueryFromJson(
    Map<String, dynamic> json) {
  final driverLocations = (json['getDriversLocation'] as List<dynamic>)
      .where((location) => location != null)
      .toList();

  return GetDriversLocation$Query()
    ..getDriversLocation = driverLocations
        .map((e) =>
            GetDriversLocation$Query$Point.fromJson(e as Map<String, dynamic>))
        .toList();
}
