...
class _RateRideSheetViewState extends State<RateRideSheetView> {
  ...
  Widget build(BuildContext context) {
    return RidySheetView(
      child: Column(
        children: [
          SheetTitleView(title: S.of(context).rate_title),
          Text(
            S.of(context).rate_body,
          ...
          if (tripRating != null)
            Column(
              ...
              children: [
                          ...
                          Expanded(
                            child: Column(
                              children: [
                                ...
                                const SizedBox(height: 4),
                                AutoSizeText(S.of(context).rate_negative_points,
                                    maxLines: 1,
                                    style:
                ...
                const SizedBox(height: 8),
                Text(
                  S.of(context).rate_add_comment_title,
                  style: Theme.of(context).textTheme.titleSmall,
                ),
                const SizedBox(height: 4),
                TextField(
                  ...
                  decoration: InputDecoration(
                      hintText: S.of(context).rate_add_comment_body,
                      isDense: true,
                            ...
                            builder:
                              ...
                              return SizedBox(
                                ...
                                child: ElevatedButton(
                                    ...
                                    child:
                                        Text(S.of(context).action_send_feedback, style: Theme.of(context).textTheme.titleMedium!.copyWith(
                                          color: Colors.white
                                        ),)),
                              );
                            })),
